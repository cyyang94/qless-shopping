...
//@interface qless_shoppingObject : NSObject
//@end

@interface qless_shoppingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[qless_shoppingObject class]])
		{
			for (NSString *key in [[(qless_shoppingObject*)o modules] allKeys])
			{
