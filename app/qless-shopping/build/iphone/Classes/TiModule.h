...
/**
 The base class for all qless_shopping modules
 */
...
/**
 qless_shopping Platform calls this method on startup.
 */
-(void)startup;

/**
 qless_shopping Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 qless_shopping Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 qless_shopping Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 qless_shopping Platform calls this method on resume.
 @param sender The sender of the event.
 */
