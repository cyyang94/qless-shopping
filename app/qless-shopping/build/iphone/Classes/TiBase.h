...
// in simulator we redefine to format for qless_shopping Developer console
...
{\
	NSString * exceptionName = [@"org.qless_shopping." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.qless_shopping";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIqless_shoppingNativeItemNone = -1, 
	UIqless_shoppingNativeItemSpinner = -2,
	UIqless_shoppingNativeItemProgressBar = -3,
	
	UIqless_shoppingNativeItemSlider = -4,
	UIqless_shoppingNativeItemSwitch = -5,
	UIqless_shoppingNativeItemMultiButton = -6,
	UIqless_shoppingNativeItemSegmented = -7,
	
	UIqless_shoppingNativeItemTextView = -8,
	UIqless_shoppingNativeItemTextField = -9,
	UIqless_shoppingNativeItemSearchBar = -10,
	
	UIqless_shoppingNativeItemPicker = -11,
	UIqless_shoppingNativeItemDatePicker = -12,
	
	UIqless_shoppingNativeItemInfoLight = -13,
	UIqless_shoppingNativeItemInfoDark = -14,
	
	UIqless_shoppingNativeItemDisclosure = -15,
	
	UIqless_shoppingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all qless_shopping instances of
