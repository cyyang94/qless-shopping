...
@interface qless_shoppingObject : KrollCoverageObject {
#else
@interface qless_shoppingObject : KrollObject {
#endif
@private
...
extern NSString * qless_shopping$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	qless_shoppingObject *_qless_shopping;
    KrollObject* console;
	BOOL shutdown;
