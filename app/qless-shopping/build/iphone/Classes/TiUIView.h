...
/**
 Base class for all qless_shopping views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the qless_shopping view hierarchy (such as wrapped iOS UIViews) was touched.
