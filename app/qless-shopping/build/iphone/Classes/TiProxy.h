...
//Rare exceptions to indicate a bug in the _qless_shopping code (Eg, function that a subclass should have implemented)
...
/**
 The base class for qless_shopping proxies.
 */
